...
def save_results(items: List[Tuple[str,int]], filename: str) -> str:
    ...
    return path
def make_compact_mail(items: List[Tuple[str,int]], signer: str = "Albert Marczak") -> str:
...
def save_mail_body_compact(items: List[Tuple[str,int]], filename: str, signer: str = "Albert Marczak") -> str:
